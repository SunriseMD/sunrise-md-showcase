  ...
  head: () => ({
    meta: [
      { title: "About — SunriseMD" },
      {
        name: "description",
        content:
          "About SunriseMD: a healthcare consulting practice partnering with founders and operators to build the next generation of health technology.",
      },
...
function AboutPage() {
  return (
    <PageShell>
      <h1 className="font-serif text-4xl tracking-tight sm:text-5xl">About {siteConfig.company}</h1>
